...
data_train_opt['dataset_name'] = 'sample'
...
data_test_opt['dataset_name'] = 'sample'
...
net_optim_params_cls = {'optim_type': 'sgd', 'lr': 0.1, 'momentum':0.9, 'weight_decay': 5e-4, 'nesterov': True, 'LUT_lr':[(10, 0.00000000000000000000000000000000000001),(20, 0.002),(30, 0.0004),(40, 0.00008)]}
networks['classifier']  = {'def_file': 'architectures/MultipleNonLinearClassifiers.py', 'pretrained': './experiments/Custom_NonLinearClassifiers_ImageNet_RotNet_AlexNet_Features_final/models/classifier_net_epoch6', 'opt': net_opt_cls, 'optim_params': net_optim_params_cls}
